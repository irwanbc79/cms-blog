<!DOCTYPE html>
<html lang="<?php echo e($site->languages && in_array('en', $site->languages) ? 'en' : 'id'); ?>">
<head>
    <meta charset="utf-8">
    ...
    <title><?php echo $__env->yieldContent('title', $seo['title'] ?? ($site->name . ' - Blog')); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', $seo['description'] ?? ''); ?>">
    <meta name="keywords" content="<?php echo e($seo['focus_keyword'] ?? ''); ?>, <?php echo e($site->name); ?>, blog, artikel">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seo['canonical'] ?? false): ?>
    <link rel="canonical" href="<?php echo e($seo['canonical']); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seo['author'] ?? false): ?>
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adsensePublisherId): ?>
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ga4Id): ?>
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($googleVerification): ?>
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', $seo['title'] ?? $site->name . ' - Blog'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', $seo['description'] ?? ''); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:locale" content="id_ID">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seo['image'] ?? false): ?>
    <meta property="og:image" content="<?php echo e($seo['image']); ?>">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seo['published_time'] ?? false): ?>
    <meta property="article:published_time" content="<?php echo e($seo['published_time']); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seo['modified_time'] ?? false): ?>
    <meta property="article:modified_time" content="<?php echo e($seo['modified_time']); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($seo['tags'])): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $seo['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('og_title', $seo['title'] ?? $site->name . ' - Blog'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('og_description', $seo['description'] ?? ''); ?>">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seo['image'] ?? false): ?>
    <meta name="twitter:image" content="<?php echo e($seo['image']); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <meta name="twitter:site" content="<?php echo e('@' . str_replace(['.', ' '], '_', $site->slug)); ?>">

    
    <link rel="alternate" type="application/rss+xml" title="<?php echo e($site->name); ?> Blog RSS Feed" href="<?php echo e(url($blogAssetPrefix . '/feed.xml')); ?>">

    
    <link rel="sitemap" type="application/xml" title="Sitemap" href="<?php echo e(url($blogAssetPrefix . '/sitemap.xml')); ?>">

    
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.google.adsense_publisher_id')): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogAssetPrefix): ?>
        <?php
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $cssFiles ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $css): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <link rel="stylesheet" href="<?php echo e($blogAssetPrefix); ?>/build/<?php echo e($css); ?>">
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($useVite): ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css']); ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($useInline): ?>
        <style>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "Blog",
        "name": "<?php echo e($site->name); ?> Blog",
        "description": "Blog dan artikel terbaru dari <?php echo e($site->name); ?>",
        "url": "<?php echo e(url('/blog')); ?>",
        "publisher": {
            "@type": "Organization",
            "name": "<?php echo e($site->name); ?>"
        }
    }
    </script>
</head>
<body class="bg-white text-gray-900 font-['Inter',sans-serif] antialiased">
    ...
    <script type="application/ld+json">
    {
        ...
        "potentialAction": {
            ...
            "target": {
                "@type": "EntryPoint",
                "urlTemplate": "<?php echo e(url('/blog')); ?>?q={search_term_string}"
            },
    ...
    <header class="border-b border-gray-100 sticky top-0 bg-white/95 backdrop-blur-sm z-50">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 font-bold text-xl text-gray-900 hover:text-blue-600 transition-colors">
                    ...
                    <img src="<?php echo e($site->logo_url); ?>" alt="<?php echo e($site->name); ?>" class="h-8 w-auto">
                    <?php else: ?>
                    <span class="bg-blue-600 text-white px-2 py-0.5 rounded text-sm"><?php echo e(substr($site->name, 0, 2)); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span class="hidden sm:inline"><?php echo e($site->name); ?></span>
                </a>

                
                <nav class="flex items-center gap-6 text-sm font-medium text-gray-600">
                    <a href="<?php echo e(url('/blog')); ?>" class="hover:text-blue-600 transition-colors <?php echo e(request()->is('blog') ? 'text-blue-600' : ''); ?>">Blog</a>
                    ...
                    <a href="<?php echo e('https://' . $site->domain); ?>" class="hover:text-blue-600 transition-colors" target="_blank" rel="noopener">Website</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div id="search-modal" class="hidden fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-start justify-center pt-24 px-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden" onclick="event.stopPropagation()">
            <form action="<?php echo e(url('/blog')); ?>" method="GET" class="p-4">
    ...
    <footer class="bg-gray-900 text-gray-400 mt-16">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-white font-semibold mb-3"><?php echo e($site->name); ?></h3>
                    <p class="text-sm leading-relaxed"><?php echo e($site->ai_prompt_context ? \Illuminate\Support\Str::limit($site->ai_prompt_context, 120) : 'Blog resmi ' . $site->name); ?></p>
                </div>
                <div>
                    <h3 class="text-white font-semibold mb-3">Blog</h3>
                    <ul class="space-y-2 text-sm">
                        <li><a href="<?php echo e(url('/blog')); ?>" class="hover:text-white transition-colors">Semua Artikel</a></li>
                        <li><a href="<?php echo e(url('/sitemap.xml')); ?>" class="hover:text-white transition-colors">Sitemap</a></li>
                        <li><a href="<?php echo e(url('/feed.xml')); ?>" class="hover:text-white transition-colors">RSS Feed</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
                &copy; <?php echo e(date('Y')); ?> <?php echo e($site->name); ?>. All rights reserved.
            </div>
        </div>
    </footer>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogAssetPrefix && isset($jsFile)): ?>
        <script type="module" src="<?php echo e($blogAssetPrefix); ?>/build/<?php echo e($jsFile); ?>"></script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($useVite): ?>
...
<?php /**PATH /Users/irwanbece/cms-blog/resources/views/blog/layouts/blog.blade.php ENDPATH**/ ?>