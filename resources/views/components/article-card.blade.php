...
<article class="group flex flex-col bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg hover:border-gray-200 transition-all duration-300">
    {{-- Featured Image --}}
    <a href="{{ url($blogAssetPrefix . '/blog/' . $article->slug) }}" class="block aspect-[16/9] overflow-hidden bg-gray-100 relative">
    ...
    <div class="flex flex-col flex-1 p-5">
        ...
        <div class="flex flex-wrap gap-1.5 mb-3">
            ...
            <span class="px-2 py-0.5 text-[11px] bg-gray-50 text-gray-500 rounded-md border border-gray-100">{{ $tag }}</span>
            @endforeach
        </div>
        @endif
