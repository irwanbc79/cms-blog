...
<body class="bg-white text-gray-900 font-sans antialiased">
    ...
    {{-- Back to Top Button (semua halaman blog) --}}
    <button type="button" id="back-to-top" aria-label="Kembali ke atas"
            onclick="window.scrollTo({top:0,behavior:'smooth'})"
            style="position:fixed;bottom:24px;right:24px;z-index:60;width:46px;height:46px;border-radius:50%;border:none;cursor:pointer;display:none;align-items:center;justify-content:center;color:#fff;background:var(--color-teal,#1a7a6a);box-shadow:0 6px 20px rgba(0,0,0,.18);transition:opacity .25s,transform .25s;opacity:0;">
