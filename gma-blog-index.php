<?php
/**
 * gma-world.id Blog Bootstrap
 *
 * Letakkan file ini di: ~/domains/gma-world.id/public_html/blog/index.php
 * SiteResolver mendeteksi 'gma-world.id' sebagai host dan memfilter artikel milik site ini.
 */
